...
var jetons=100;
var mise=prompt("Le but du BlackJack est de ne pas dépasser 21 sans que le dealer ne vous dépasse. Si vous perdez (en ayant un score supérieur à 21 ou inférieur à celui du dealer), vous perdez votre mise. Si vous gagnez, vous récupérez le doucle de ce que vous avez misé. \nVous commencez avec 100 jetons ; le but est d'en récupérer 1 000. Combien de jetons souhaitez vous miser ?");
var myScore=0;
var dealerScore=0;
var nbCards=52;
